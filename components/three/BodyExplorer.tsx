...
export const HOTSPOTS: Hotspot[] = [
  ...
  },
  {
    ...
    title: 'Конечности',
    latin: 'Membra',
    text: 'Послойные мышечные препараты предплечья и голени, суставы в разрезе, рядом — рентгенограммы тех же областей. Здесь же ключицы и лопатки плечевого пояса.',
    position: [0.68, 1.22, 0.32],
    camera: [1.2, 0.3, 2.0],
  },
];
